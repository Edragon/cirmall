...
void SX1276LoRaInit( void )
{
    ...
    SX1276LoRaSetLowDatarateOptimize( true );
 	  ...
 	  SX1276LR->RegOcp= 0x1F;// enable current over project,Imax =120mA
		SX1276Write (REG_LR_OCP, SX1276LR->RegOcp);
